...
function setup(){
  ...
  x=30;
  y=530;
  xf=[0,300,60,300,700,700,1250,1249,1000,1000,1150,1200,1249,1200,1050,945,899,1030,901,850,800,600,650,221,220,220];
  yf=[520,330,550,400,500,550,550,450,450,450,400,300,450,0,95,200,400,51,180,350,400,100,50,100,50,50];
  xl=[300,700,300,700,1200,1250,1249,1150,1150,1200,1201,1200,1250,1250,1201,1050,945,1200,1030,901,899,800,850,600,650,221];
...
function draw(){
  ...
  for(let i=0; i<xf.length; i++){
    ...
    if(o<10&&sqrt((x-xf)*(x-xf)+(y-yf)*(y-yf))<sqrt((xl-xf)*(xl-xf)+(yl-yf)*(yl-yf))&&sqrt((x-xl)*(x-xl)+(y-yl)*(y-yl))<sqrt((xl-xf)*(xl-xf)+(yl-yf)*(yl-yf))){
      x=30;
      y=530;
    }
